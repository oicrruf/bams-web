            ...
            <div>
                ...
                <div className="contentViewer d-flex ">
                    ...
                    <div className="bg-body-secondary d-flex flex-column" style={{ width: '100%' }}>
                        ...
                        {/* Contenedor de app */}
                        <div className="d-flex flex-column shadow p-3 mb-5 bg-body-tertiary rounded" style={{ width: '96%', height: '80%', margin: '2%' }}>
                            ...
                            <div className="navbarContent d-flex flex-row  align-items-center w-100">
                                <div className="form form-control d-flex flex-row justify-content-center align-items-center">
                                    ...
                                    <input type="text" className="form-control form-input border-0" placeholder="Search anything..." />
                                    <span className="left-pan"><i className="fa fa-microphone" /></span>
                                </div>
                                <button type="button" className="btn btn-outline-primary mx-2 d-flex flex-row">
                                    <i className="bi bi-search me-2 text-primary" />
                                    Buscar</button>
                                <button type="submit" className="btn btn-primary">+ Agregar inmueble</button>
                            </div>
                            {/* Tabla de datos */}
...
export default DashboardWithBuild
